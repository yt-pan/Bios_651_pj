...
a$REC_AGE_C4 = 0
a$REC_AGE_C4[which(a$REC_AGE_AT_TX>=0&a$REC_AGE_AT_TX<=39)] = '0-39'
a$REC_AGE_C4[which(a$REC_AGE_AT_TX>=40&a$REC_AGE_AT_TX<=59)] = '40-59'
a$REC_AGE_C4[which(a$REC_AGE_AT_TX>=60)] = '>=60'
a$REC_AGE_C4=factor(a$REC_AGE_C4,levels = c(
  '0-39', '40-59', '>=60'
)) 
...
# basic model:
```{r}
multi.vglm<-vglm(as.factor(event) ~ factor(center)
                 +DON_HIST_DIAB
                 +DON_GENDER
                 +DON_BMI_C
                 +DON_AGE_C4
                 ...
                 +REC_DIAB
                 +REC_DIAL_YRS,
                 data=a, family = multinomial(refLevel = 1))
summary(multi.vglm)
```
# seprate the rec_race

```{r}
data_black=a[which(a$REC_RACE==1),]
data_nonblack=a[which(a$REC_RACE==0),]
save(data_black,file='./data_black.RData')
save(data_nonblack,file='./data_nonblack.RData')
```
